...
parser.add_argument('--root_path', type=str,
                    default='../data/RICE/VOC2012',
                    help='Dataset root path')
parser.add_argument('--disease', type=str, required=True,
                    choices=['RLDSD', 'ALDD'],
                    help='Disease type')
parser.add_argument('--exp', type=str,
                    default='RICE/Fully_Supervised', help='experiment_name')
...
parser.add_argument(
    "--opts", help="Modify config options by adding 'KEY VALUE' pairs. ", default=None, nargs='+', )
